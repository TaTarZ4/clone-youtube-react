  ...
  return (
    <>
        <div className='navbar'>
            <div className="left">
                <div className="icon-menu" onClick={(e)=>{setOpenMenu(!openMenu)}}>
                    <svg height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
                </div>
                <Link to={'/'} href='' className='icon-youtube'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="external-icon" viewBox="0 0 90 20" focusable="false" style={{"pointerEvents": "block", display: "block", width: "90px", height: "100%"}}>
            ...
            <div className="center">
                <div className="search">
                    <div className="input">
                        <input type="text" placeholder="ค้นหา" value={input} onChange={(e) => setInput(e.target.value)}/>
                        <div className="history"    style={ input === '' ? {display: 'none'}:{display: 'block'} } >
                ...
                <div className="mobile-icon-search" onClick={()=>{setOpenSearchMobile(!openSearchMobile)}}>
                        <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="m20.87 20.17-5.59-5.59C16.35 13.35 17 11.75 17 10c0-3.87-3.13-7-7-7s-7 3.13-7 7 3.13 7 7 7c1.75 0 3.35-.65 4.58-1.71l5.59 5.59.7-.71zM10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"></path></svg>
                </div>
            ...
            <div className="right">
                <div className="icon-camera">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2zm3-7H3v12h14v-6.39l4 1.83V8.56l-4 1.83V6m1-1v3.83L22 7v8l-4-1.83V19H2V5h16z"></path></svg>
                </div>
        ...
        <div className="mobile-search" style={ openSearchMobile ? {display:'block'}:{display:'none'}}>
            <div className="search">
                <div className="icon-arrow-left" onClick={()=>{setOpenSearchMobile(!openSearchMobile)}}>
        ...
        <div className="left-menu" style={openMenu ? {display: 'block'}:{display: 'none'}}>
            <div className="menu">
                <div className="logo">
                    <div className="icon" onClick={(e)=>{setOpenMenu(!openMenu)}}>
                        <svg height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
                    </div>
                    <div className='icon-youtube'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="external-icon" viewBox="0 0 90 20" focusable="false" style={{"pointerEvents": "block", display: "block", width: "100%", height: "100%"}}>
                            <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M27.9727 3.12324C27.6435 1.89323 26.6768 0.926623 25.4468 0.597366C23.2197 2.24288e-07 14.285 0 14.285 0C14.285 0 5.35042 2.24288e-07 3.12323 0.597366C1.89323 0.926623 0.926623 1.89323 0.597366 3.12324C2.24288e-07 5.35042 0 10 0 10C0 10 2.24288e-07 14.6496 0.597366 16.8768C0.926623 18.1068 1.89323 19.0734 3.12323 19.4026C5.35042 20 14.285 20 14.285 20C14.285 20 23.2197 20 25.4468 19.4026C26.6768 19.0734 27.6435 18.1068 27.9727 16.8768C28.5701 14.6496 28.5701 10 28.5701 10C28.5701 10 28.5677 5.35042 27.9727 3.12324Z" fill="#FF0000"></path>
                                    <path d="M11.4253 14.2854L18.8477 10.0004L11.4253 5.71533V14.2854Z" fill="white"></path>
                ...
                <div className="follow">
                    ...
                    <div className="listItem">
                    {
                        creator.map((e)=>{
                            return (
                                <Link to={`/creator/${e.id}`} class="item">
            ...
            <div className="overly" onClick={(e)=>{setOpenMenu(!openMenu)}}></div>
        </div>
    </>
  )
}
